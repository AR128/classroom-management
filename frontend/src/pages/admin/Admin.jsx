    ...
    <div className="min-h-screen bg-slate-50 font-sans p-6 md:p-12 relative overflow-hidden flex items-center justify-center selection:bg-blue-200 selection:text-blue-900">
      ...
      <div className="bg-white/70 backdrop-blur-md border border-white/40 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 max-w-3xl w-full p-8 md:p-14 relative z-10">
        <div className="text-center mb-10">
          <div className="mx-auto w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 mb-6 shadow-sm border border-blue-200/50">
             <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
          </div>
          <p className="text-xs uppercase tracking-[0.2em] text-blue-600 font-bold bg-blue-50/50 inline-block px-3 py-1 rounded-full border border-blue-100 backdrop-blur-sm">
            Admin Access
          </p>
          ...
          <p className="mt-4 text-lg text-slate-500 font-medium">
            Continue to manage student records and academic data securely.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            ...
            <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-white text-blue-600 shadow-sm">
            ...
            <div className="text-xs font-bold uppercase tracking-widest text-blue-500">Access Console</div>
